...
add wave -noupdate -radix hexadecimal /tb_top/DUT/i_waddr
...
add wave -noupdate -radix hexadecimal /tb_top/DUT/o_cmd_data
...
add wave -noupdate -radix unsigned /tb_top/DUT/expected_cols
add wave -noupdate -radix unsigned /tb_top/DUT/expected_pkts
add wave -noupdate -radix unsigned /tb_top/DUT/current_pkts
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {9375 ps} 0}
